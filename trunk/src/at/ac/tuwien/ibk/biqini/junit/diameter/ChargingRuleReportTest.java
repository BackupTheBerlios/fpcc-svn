...
public class ChargingRuleReportTest extends AVPJunit{
	...
	public final void testChargingRuleReport()	{
		...
		assertEquals(pcc, c.getPCCRuleStatus());
		}
	}
