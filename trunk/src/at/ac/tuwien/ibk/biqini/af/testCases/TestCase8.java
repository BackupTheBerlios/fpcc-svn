...
public class TestCase8 extends AFMainTest implements AFTestCase {

	public String TestName() {
		return "PRE - Final(wrong codecs) ";
	}

	public String getDescription() {
		StringBuffer sbf = new StringBuffer();
		sbf.append("AF send AAR (pre) with offer and answer (several codecs) for Auido\n");
		sbf.append("AF send AAR (final) with offer and answer (only 1 not allowed codec) for Auido\n");
		sbf.append("PCRF response with 5012\n");
		return sbf.toString();
	}
