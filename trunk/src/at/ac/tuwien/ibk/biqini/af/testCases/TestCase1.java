...
public class TestCase1 extends AFMainTest implements AFTestCase {
	...
	public String getDescription() {
		...
		sbf.append("AF send AAR (final) with offer and answer (only 1 codec) for Auido\n");
		sbf.append("AF send STR\n");
		sbf.append("All has to be acknowledged with 2001\n");
		return sbf.toString();
	}
