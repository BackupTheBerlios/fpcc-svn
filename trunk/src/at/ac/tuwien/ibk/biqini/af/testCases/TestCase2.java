...
public class TestCase2 extends AFMainTest implements AFTestCase {

	int preCycles;
	int finalCycles;
	
	public String TestName() {
		return "multiple AAR SUCCESSFULL Call";
	}
	 ...
	 * @param finalCycles
	 */
	public TestCase2(int preCycles, int finalCycles) {
		super();
