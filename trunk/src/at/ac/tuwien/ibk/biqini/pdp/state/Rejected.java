...
public class Rejected extends State {
	...
	private Logger log = Logger.getLogger("Rejected");
	
	public Rejected(StateMachine machine) {
		super(machine);
		// TODO Auto-generated constructor stub
	}
	
	public Rejected(StateMachine machine, String _reasonMessage) {
		super(machine);
		reason = _reasonMessage;
		log.log(Level.WARNING, _reasonMessage);
		// TODO Auto-generated constructor stub
	}
